...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_tMainSplitter.CreateView(0, 1, RUNTIME_CLASS(CDiablo_II_MapToolView), CSize(1280, 720), pContext);
	m_tSecondSplitter.CreateView(0, 0, RUNTIME_CLASS(CMiniView), CSize(300, 300), pContext);
	m_tSecondSplitter.CreateView(1, 0, RUNTIME_CLASS(CMyForm), CSize(300, 300), pContext);
	m_tMainSplitter.SetColumnInfo(0, 300, 10);

	m_pDiabloMapToolView = (CDiablo_II_MapToolView*)m_tMainSplitter.GetPane(0, 1);
	/*
	0, 0 ,  0, 1
	1, 0 ,  1, 1
	*/
